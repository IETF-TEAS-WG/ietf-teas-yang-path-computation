...
docname: draft-ietf-teas-yang-path-computation-latest
...
## Packet/Optical Integration {#poi-uc}
...
## Multi-domain TE networks {#md-uc}
...
## Data Center Interconnections {#dci-uc}
...
## Backward Recursive Path Computation scenario {#brpc-uc}
...
## Hierarchical PCE scenario {#hpce-uc}
...
## Motivation for a YANG Model {#yang-motivation}
...
## Interactions with TE topology {#topo-interaction}
...
### TE topology aggregation {#topo-aggregation}
...
### Complementary use of the TE topology {#topo-pc-complement}
...
## Path Computation RPC {#rpc-motivation}
...
### Temporary reporting of the computed path state {#temp-state}
...
~~~~
~~~~ json
{::include-fold ./json/transient-state.json}
~~~~
...
~~~~
~~~~ json
{::include-fold ./json/global-path-constraint.json}
~~~~
{: sourcecode-markers="false" sourcecode-name="global-path-constraint.json"}

## Path Computation with Per-tunnel Path Constraint {#tunnel-path-constraint-example}
...
~~~~
~~~~ json
{::include-fold ./json/tunnel-path-constraint.json}
~~~~
...
~~~~
~~~~ json
{::include-fold ./json/computed-path.json}
~~~~
...
~~~~ json
{::include-fold ./json/primary-secondary-paths.json}
~~~~
